...
- **顶会机制承压**：审稿人负载过高、领域狭窄、存在相互bid的乱象、利益冲突与圈子效应，使得少数gatekeeper很难稳定代表整个社区的判断

我们需要的不只是一个「谁被接收了」的列表，而是一个更接近 **Crowdsourcing（众包打分）** 的机制，让更大范围的研究者、工程师和实践者，用真实的阅读、投票、复现与Star行为，共同决定哪些论文值得被看见。
